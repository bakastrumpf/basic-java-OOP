...
/****************************************************************************
 * Primer programa koji računa sumu, razliku, proizvod i količnik dva broja.
 * Brojeve zadaje korisnik preko tastature. 
 * Unos, sabiranje, oduzimanje, množenje, deljenje i prikaz rezultata 
 * implementirane su kao zasebne funkcije.
 *****************************************************************************/
public class KalkulatorPotprogrami {
